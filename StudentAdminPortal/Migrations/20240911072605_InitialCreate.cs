    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentDetails", x => new { x.StudentId, x.CourseId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentDetails_Semesters_SemesterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentSemester", x => new { x.StudentId, x.SemesterId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentDetails_SemesterId",
                table: "StudentDetails",
                column: "SemesterId");
